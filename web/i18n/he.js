...
window.NoslopI18N.catalogs.he = {
  ...
  "hero.heading": "בודק הכתיבה הדטרמיניסטי היחיד לטקסטים של בינה מלאכותית שדובר 16 שפות.",
  "hero.tagline": "הדבק טיוטה למטה. noslop מצביע בדיוק על המילים וההרגלים שמסגירים את זה - בלי מודל, בלי להעלות שום דבר - כדי שתוכל לתקן אותם לפני שאתה שולח.",
