...
window.NoslopI18N.catalogs.th = {
  ...
  "hero.heading": "เครื่องมือตรวจงานเขียน AI แบบไม่ใช้โมเดลเพียงหนึ่งเดียวที่รองรับ 16 ภาษา",
  "hero.tagline": "วางร่างข้อความไว้ด้านล่าง noslop จะชี้ตรงจุดคำและความเคยชินที่บ่งบอกให้เห็น - ไม่มีโมเดล ไม่มีการอัปโหลด - เพื่อให้คุณแก้ไขได้ก่อนส่ง",
