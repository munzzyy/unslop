...
window.NoslopI18N.catalogs.fa = {
  ...
  "hero.heading": "تنها ویرایشگر قطعی متن هوش مصنوعی که به ۱۶ زبان مسلط است.",
  "hero.tagline": "پیش‌نویسی را پایین جای‌گذاری کن. noslop دقیقاً همان کلمه‌ها و عادت‌هایی را نشان می‌دهد که آن را لو می‌دهند - بدون مدل، بدون آپلود - تا پیش از فرستادن درستشان کنی.",
